...
{
    public class TestsGenerateCurrenciesMaxTwo : TestsGenerateCurrencies
    {
        ...
        public void Generate_5_Two_Allowed()
        {
            ...
            Assert.IsTrue(Run(5, nameof(Generate_5_Two_Allowed),
        ...
        public void Generate_6_Two_Allowed()
        {
            ...
            Assert.IsTrue(Run(6, nameof(Generate_6_Two_Allowed),
        ...
        public void Generate_7_Two_Allowed()
        {
            ...
            Assert.IsTrue(Run(7, nameof(Generate_7_Two_Allowed),
                expectedResult1, expectedResult2, expectedResult3, expectedResult4));
        }
        ...
        public void Generate_8_Two_Allowed()
        {
            ...
            Assert.IsTrue(Run(8, nameof(Generate_8_Two_Allowed),
                expectedResult1, expectedResult2, expectedResult3, expectedResult4,
                expectedResult5));
        }
        ...
        public void Generate_9_Two_Allowed()
        {
            ...
            Assert.IsTrue(Run(9, nameof(Generate_9_Two_Allowed),
                expectedResult1, expectedResult2, expectedResult3, expectedResult4,
                expectedResult5));
        }
        ...
        public void Generate_13_Two_Allowed()
        {
            ...
            Assert.IsTrue(Run(13, nameof(Generate_13_Two_Allowed),
                expectedResult1, expectedResult2, expectedResult3, expectedResult4,
